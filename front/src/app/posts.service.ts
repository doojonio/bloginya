  ...
  newPosts: NewPost[] = [
    {
      ...
      category_name:
        '한국어 한국어한국어한국어한국어한국어한국어한국어한국어한국어한국어한국어한국어',
      created_at: new Date('2024-05-29'),
      title:
        '벚꽃 안녕하세요 벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요',
      tags: ['봄', '벚꽃'],
    },
    {
      picture:
      ...
      created_at: new Date('2024-05-29'),
      title: 'Здравствуйте, люди Здравствуйте, людиЗдравствуйте, людиЗдравствуйте, людиЗдравствуйте, людиЗдравствуйте, людиЗдравствуйте, людиЗдравствуйте, люди',
      tags: ['봄', '벚꽃'],
    },
    {
      picture:
      ...
      created_at: new Date('2024-05-29'),
      title: 'Hello, people! , people!, people!, people!, people!, people!, people!, people!',
      tags: ['봄', '벚꽃'],
    },
    {
      picture:
  ...
  langPosts: LangPost[] = [
    {
      ...
      picture:
        'https://postfiles.pstatic.net/MjAyNDAyMjZfMTUw/MDAxNzA4OTMwNDUxMDMz.Djj0xHVfnj7IcVDtnTfzjCd-YKKEUS25373Thhuwz2Ag.yOERrqOoTDxetYq_LSxH1ZeYRzqawhEL_UZYNLJKQBcg.JPEG/IMG%EF%BC%BF20240215%EF%BC%BF130740.jpg?type=w3840',
      title:
        '벚꽃 안녕하세요 벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요벚꽃 안녕하세요',
      descr:
        '안녕하세요 여러분. 십알 안녕하세요 여러분. 십알안녕하세요 여러분. 십알안녕하세요 여러분. 십알안녕하세요 여러분. 십알안녕하세요 여러분. 십알',
      tags: [
        '봄',
        '벚꽃',
        '봄',
